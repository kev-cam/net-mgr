...
BINS  = net-alias net-poll-ap net-audit net-connect net-diag net-discover net-find-lost net-find-peers net-find-rogue-dhcp net-fw net-gen-apache-conf net-gen-dnsmasq net-import-dhcp net-import-ssh-forwards net-fix net-lookup net-name net-ping net-kill-rogue-dhcp net-roam net-router net-scan net-report net-show net-ssh net-tp-scan net-uplink-probe net-var net-watch net-wifi-survey net-zones
