...
BINS  = net-alias net-poll-ap net-audit net-audit-aps net-cluster net-cluster-gui net-connect net-diag net-discover net-find-lost net-find-peers net-find-rogue-dhcp net-fw net-gen-apache-conf net-gen-dnsmasq net-import-dhcp net-import-ssh-forwards net-fix net-isp net-link-stats net-lookup net-name net-peer net-ping net-kill-rogue-dhcp net-roam net-router net-run-app net-scan net-report net-set net-show net-tp-scan net-uplink-probe net-var net-watch net-wifi-survey net-zones
...
MAN1S = net-alias.1 net-connect.1 net-diag.1 net-discover.1 net-fix.1 \
...
LIBS  = NetMgr/Where.pm NetMgr/Protocol.pm NetMgr/Config.pm NetMgr/DB.pm \
        NetMgr/Manager.pm NetMgr/Client.pm NetMgr/Multi.pm NetMgr/Resolver.pm \
