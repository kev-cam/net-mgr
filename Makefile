...
BINS  = net-alias net-chat net-poll-ap net-audit net-audit-aps net-cluster net-cluster-gui net-config-gui net-connect net-ddns net-diag net-discover net-find-lost net-find-peers net-find-rogue-dhcp net-fw net-gen-apache-conf net-gen-dnsmasq net-import-dhcp net-import-dnsmasq net-import-ssh-forwards net-fix net-ipv6 net-isp net-link-stats net-lookup net-name net-peer net-ping net-kill-rogue-dhcp net-reserve net-roam net-router net-run-app net-scan net-report net-set net-show net-tp-scan net-uplink-probe net-var net-watch net-wifi-survey net-zones
...
SBINS = net-mgr net-mgr-setup net-dns net-mgr-relay net-mgr-self-update net-mgr-deploy net-mgr-netif-hook
...
MAN7S = net-mgr.7
LIBS  = NetMgr/Where.pm NetMgr/Protocol.pm NetMgr/Addr.pm NetMgr/Vlan.pm NetMgr/Tunnel.pm NetMgr/Ddns.pm NetMgr/Config.pm NetMgr/DB.pm \
