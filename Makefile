...
BINS  = net-add-public-dns net-alias net-bitchat-bridge net-bitchat-helper-wrap net-mgr-bitchat-setup net-chat net-chat-askpass net-chat-autoresponder net-poll-ap net-audit net-audit-aps net-cluster net-cluster-gui net-config-gui net-connect net-ddns net-ddnx net-dhcp-cycle net-diag net-discover net-find net-fw net-gen-apache-conf net-gen-dnsmasq net-import-dhcp net-import-dnsmasq net-import-ssh-forwards net-fix net-ipv6 net-isp net-link-stats net-lookup net-mac net-name net-peer net-ping net-purge net-vlan net-kill-rogue-dhcp net-reserve net-roam net-router net-run-app net-scan net-report net-set net-show net-onvif net-range net-tp-scan net-tunnel net-he-tunnel net-uplink-probe net-var net-wakeup net-watch net-wifi-survey net-zones
