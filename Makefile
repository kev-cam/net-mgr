...
BINS  = net-alias net-poll-ap net-discover net-find-lost net-find-peers net-gen-dnsmasq net-import-dhcp net-import-ssh-forwards net-fix net-lookup net-name net-ping net-roam net-router net-scan net-report net-show net-tp-scan net-uplink-probe net-var net-watch net-zones
